...
def _resnet(arch, block, layers, pretrained, progress,name, create_time, num_classes, **kwargs):
    model = ResNet(block,layers, name, create_time, num_classes=num_classes, **kwargs)
    # if pretrained:
...
def resnet18(pretrained=False, num_classes = 200, progress=True,name=None, created_time=None,  **kwargs):
    ...
    """
    return _resnet('resnet18', BasicBlock, [2, 2, 2, 2], pretrained, progress,'{0}_ResNet_18'.format(name), created_time, num_classes,
                   **kwargs)
